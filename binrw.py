...
class binread:
	...
	def remaining(self): return self.tell()
	...
	def int_float(self): return (self.unp_float_b if self.state.endian else self.unp_float_l)(self.str.read(4))[0] 
	def int_double(self): return (self.unp_double_b if self.state.endian else self.unp_double_l)(self.str.read(8))[0] 
	...
	def int_float_b(self): return self.unp_float_b(self.str.read(4))[0]
	def int_double_b(self): return self.unp_double_b(self.str.read(8))[0]
	...
	def internal_readarr(self, num, numbytes, dtype): return np.frombuffer(self.read(num), dtype)
	...
	def list_int_float(self, num): return self.internal_readarr(num, 4, self.dt_float_b if self.state.endian else self.dt_float_l)
	def list_int_double(self, num): return self.internal_readarr(num, 8, self.dt_double_b if self.state.endian else self.dt_double_l)
	...
	def list_int_float_b(self, num): return self.internal_readarr(num, 4, self.dt_float_b)
	def list_int_double_b(self, num): return self.internal_readarr(num, 8, self.dt_double_b)
	...
	def list_int_float_l(self, num): return self.internal_readarr(num, 4, self.dt_float_l)
	def list_int_double_l(self, num): return self.internal_readarr(num, 8, self.dt_double_l)